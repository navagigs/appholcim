...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2019 at 02:14 PM
...
CREATE TABLE `sertifikasi` (
  ...
  `karyawan_nip` varchar(50) NOT NULL,
  `karyawan_email` varchar(250) NOT NULL,
  ...
  `sertifikasi_gambar` varchar(250) NOT NULL,
  `penerima_id` int(11) NOT NULL,
  `departemen_id` int(11) NOT NULL,
  `subarea_id` int(11) NOT NULL,
...
INSERT INTO `sertifikasi` (`sertifikasi_id`, `karyawan_nip`, `karyawan_email`, `sertifikasi_nama`, `sertifikasi_tgl`, `sertifikasi_noreg`, `sertifikasi_tglpelaksanaan`, `sertifikasi_provider`, `sertifikasi_status`, `sertifikasi_tglberlaku`, `sertifikasi_masaberlaku`, `sertifikasi_keterangan`, `sertifikasi_gambar`, `penerima_id`, `departemen_id`, `subarea_id`, `tahun_id`) VALUES
(2, '1144096', 'navagiaginasta@gmail.com1', 'Web developers', '2017-10-12', 'SERT/123/12P2', '2017-10-13', 'Telkom', 'PERPANJANGAN', '2022-10-12', '2020-10-12', '-', '1552309990-web-developers.jpg', 1, 1, 3, 1);
